...
import img3 from "../../images/DonateMed.jpg"
...
render(){
  ...
  return (
      <div>
		   <img src={img3} class="img-fluid img-thumbnail rounded"  alt="Responsive image" width={1500}></img>
    <h1>Medicine</h1>
    {list1}
    </div>
  );
